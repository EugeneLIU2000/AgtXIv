...
\texttt{tmp/claim-interface-study/extracted/2608.12646/main.tex}, including
...
reported accepted cross-section range.
...
minimality, qualitative region, and future-work claims. The case therefore
supports a small core interface with exact source spans, atomic statements,
scope, modality, attribution, optional mathematical normalization, and visible
pressure flags rather than a physics-specific expansion of the Registry.