...
def _policy_fixture():
    ...
    vector_rows.sort(key=lambda row:row["vector_id"].encode());vectors_doc={"vector_set_id":"vectors:checkpoint-e-planning-families/1.0.0","vector_set_version":"1.0.0","fixture_purpose":"STRUCTURAL_CONFORMANCE_ONLY","vectors":vector_rows}
