...
class DiagnosticCode(StrEnum):
    ...
    CODE_CATALOG_INVALID = "AGTXIV.CODE.CATALOG_INVALID"
    CODE_ENUM_PROJECTION_MISMATCH = "AGTXIV.CODE.ENUM_PROJECTION_MISMATCH"
    CODE_POLICY_REFERENCE_INVALID = "AGTXIV.CODE.POLICY_REFERENCE_INVALID"
    CODE_POLICY_INVALID = "AGTXIV.CODE.POLICY_INVALID"
    CODE_EMITTED_DIAGNOSTIC_UNREGISTERED = "AGTXIV.CODE.EMITTED_DIAGNOSTIC_UNREGISTERED"
    REASON_UNREGISTERED = "AGTXIV.REASON.UNREGISTERED"
    REASON_CONSTRAINT_MISMATCH = "AGTXIV.REASON.CONSTRAINT_MISMATCH"
